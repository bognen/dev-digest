...
/** Settings -> Feature Models id whose model runs the scan. */
export const CONVENTIONS_FEATURE = 'conventions' as const;

/** The skill every scan feeds. One skill per workspace, upserted by name. */
...
/** How many supporting files a clustered candidate remembers. */
export const MAX_EVIDENCE_FILES = 12;

/** Rejected rules replayed to the model as "already dismissed" (decision memory). */
export const MAX_REJECTED_IN_PROMPT = 25;
