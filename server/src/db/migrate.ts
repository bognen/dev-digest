...
// CLI entrypoint. Compared as filesystem paths (not raw strings) because
// import.meta.url is a file:// URL (forward slashes, %-encoded) while
// process.argv[1] is an OS path (backslashes on Windows) — the naive string
// comparison never matches on Windows, silently skipping this whole block.
