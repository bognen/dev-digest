...
export interface ReviewInput {
  ...
  /**
   * Optional derived PR intent (T-Intent). Untrusted; delimiter-wrapped +
   * truncated downstream. Empty/undefined → section omitted (byte-identical
   * to a prompt with no intent). Map-reduce: every chunk's messages carry it.
   */
  intent?: PromptIntent;
