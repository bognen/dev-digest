...
import { formatSeconds, formatTokens, formatCost, skillsTokenCount } from "../../helpers";
...
export function TraceBody({ trace, findings }: { trace: RunTrace; findings: FindingRecord[] }) {
  ...
  const skillsTokens = skillsTokenCount(trace);
  return (
    <>
      ...
      <TraceSection icon="FileText" title={t("trace.promptAssembly")} defaultOpen={false}>
        ...
        {trace.prompt_assembly.skills != null && (
          <PromptBlock
            ...
            badge={skillsTokens != null ? t("trace.prompt.skillsTokens", { count: skillsTokens }) : undefined}
          />
        )}
