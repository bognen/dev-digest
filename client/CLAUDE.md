...
- `src/vendor/ui/` — vendored `@devdigest/ui` design system.
  See [vendor/ui/CLAUDE.md](./src/vendor/ui/CLAUDE.md).
...
- Real browser journeys are covered by [`../e2e`](../e2e/CLAUDE.md), not by
...
- `src/vendor/ui/**` — vendored design system; edits should be deliberate (see its
  own CLAUDE.md) and kept usable across the whole app.
...
[vendor/ui/CLAUDE.md](./src/vendor/ui/CLAUDE.md) · [Testing strategy](../TESTING.md) ·
